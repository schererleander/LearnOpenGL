...
int main() {
  ...
  Shader ourShader("src/01_getting_started/textures_exercise4/shader.vs", "src/01_getting_started/textures_exercise4/shader.fs");
...
void processInput(GLFWwindow *window) {
  ...
  if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) {
    mixValue = std::clamp(mixValue + 0.1, 0.0, 1.0);
  }
