...
int main() {
  ...
  Shader cubeShader("src/02_lighting/lighting_maps_exercise4/cube.vs", "src/02_lighting/lighting_maps_exercise4/cube.fs");
  Shader lightCubeShader("src/02_lighting/lighting_maps_exercise4/lightCube.vs", "src/02_lighting/lighting_maps_exercise4/lightCube.fs");
  ...
  unsigned specularMap = loadTexture("resources/texturescontainer2_specular_colored.png");
  unsigned emissionMap = loadTexture("resources/texturesmatrix.jpg");
