...
int main() {
  ...
  Shader cubeShader("src/02_lighting/lighting_maps_exercise3/cube.vs", "src/02_lighting/lighting_maps_exercise3/cube.fs");
  Shader lightCubeShader("src/02_lighting/lighting_maps_exercise3/lightCube.vs", "src/02_lighting/lighting_maps_exercise3/lightCube.fs");
