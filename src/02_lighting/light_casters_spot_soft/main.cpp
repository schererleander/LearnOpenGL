...
int main() {
  ...
  Shader cubeShader("src/02_lighting/light_casters_spot_soft/cube.vs", "src/02_lighting/light_casters_spot_soft/cube.fs");
  Shader lightCubeShader("src/02_lighting/light_casters_spot_soft/lightCube.vs", "src/02_lighting/light_casters_spot_soft/lightCube.fs");
