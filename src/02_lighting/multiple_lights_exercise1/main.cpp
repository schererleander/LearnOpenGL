...
glm::vec3 backgroundColor(0.95f, 0.7f, 0.3f);
...
int main() {
  ...
  Shader cubeShader("src/02_lighting/multiple_lights_exercise1/cube.vs", "src/02_lighting/multiple_lights_exercise1/cube.fs");
  Shader lightCubeShader("src/02_lighting/multiple_lights_exercise1/lightCube.vs", "src/02_lighting/multiple_lights_exercise1/lightCube.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    for (std::size_t i = 0; i < std::size(pointLightPositions); ++i) {
        ...
        glm::vec3 ambient = (pointLightColors[i] + backgroundColor) * 0.1f;
        glm::vec3 diffuse = (pointLightColors[i] + backgroundColor) * 0.8f;

        cubeShader.setVec3(light + ".position", pointLightPositions[i]);
        cubeShader.setVec3(light + ".ambient", ambient);
        cubeShader.setVec3(light + ".diffuse", diffuse);
        cubeShader.setVec3(light + ".specular", pointLightColors[i]);
