...
int main() {
  ...
  Shader cubeShader("src/02_lighting/lighting_maps_diffuse/cube.vs", "src/02_lighting/lighting_maps_diffuse/cube.fs");
  Shader lightCubeShader("src/02_lighting/lighting_maps_diffuse/lightCube.vs", "src/02_lighting/lighting_maps_diffuse/lightCube.fs");
