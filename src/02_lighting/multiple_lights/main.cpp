...
int main() {
  ...
  Shader cubeShader("src/02_lighting/multiple_lights/cube.vs", "src/02_lighting/multiple_lights/cube.fs");
  Shader lightCubeShader("src/02_lighting/multiple_lights/lightCube.vs", "src/02_lighting/multiple_lights/lightCube.fs");
