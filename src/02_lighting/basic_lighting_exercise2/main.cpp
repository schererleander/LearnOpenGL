...
int main() {
  ...
  Shader cubeShader("src/02_lighting/basic_lighting_exercise2/cube.vs", "src/02_lighting/basic_lighting_exercise2/cube.fs");
  Shader lightCubeShader("src/02_lighting/basic_lighting_exercise2/lightCube.vs", "src/02_lighting/basic_lighting_exercise2/lightCube.fs");
