...
int main() {
  ...
  Shader cubeShader("src/02_lighting/basic_lighting_exercise1/cube.vs", "src/02_lighting/basic_lighting_exercise1/cube.fs");
  Shader lightCubeShader("src/02_lighting/basic_lighting_exercise1/lightCube.vs", "src/02_lighting/basic_lighting_exercise1/lightCube.fs");
