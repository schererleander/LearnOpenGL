...
int main() {
  ...
  Shader cubeShader("src/02_lighting/lighting_maps_specular/cube.vs", "src/02_lighting/lighting_maps_specular/cube.fs");
  Shader lightCubeShader("src/02_lighting/lighting_maps_specular/lightCube.vs", "src/02_lighting/lighting_maps_specular/lightCube.fs");
