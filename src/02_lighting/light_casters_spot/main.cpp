...
int main() {
  ...
  Shader cubeShader("src/02_lighting/light_casters_spot/cube.vs", "src/02_lighting/light_casters_spot/cube.fs");
  Shader lightCubeShader("src/02_lighting/light_casters_spot/lightCube.vs", "src/02_lighting/light_casters_spot/lightCube.fs");
